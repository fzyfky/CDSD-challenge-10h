...
data=/data/databases/XinChen_audio/
data_url=www.openslr.org/resources/33

nj=16
dict=/home/fengky/kangxinchen-model/wenetspeech_u2pp_conformer_exp/units.txt
#dict=data/dict/lang_char.txt
# 先跑到stage3，再将dict替换还有cmvn替换
...
train_config=/home/fengky/kangxinchen-model/wenetspeech_u2pp_conformer_exp/train.yaml
cmvn=true
dir=exp/conformer
checkpoint=/home/wangsq/wenet/examples/w10/s0/model_wenetspeech/final.pt
